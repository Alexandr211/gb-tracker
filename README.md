...
<h4>Hello! My name is Alexander Bashtanov</h4>
    ...
    <br>Free. Use of this service is completely free. All the time. Just download this pack and apply some migrations ('composer update' and 'Yii migrate/up'). To run the WS Chat, configure the host url at frontend/web/js/client.js (line 5) and use Yii console command (php yii server/init)<br><br>
    </p>
<p>   
